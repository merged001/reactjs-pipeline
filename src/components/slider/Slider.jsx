...
import imgbg from "../../assets/images/backgroup-secsion/nft-bg.jpg";
...
const SliderItem = (props) => (
  <div className="flat-title-page" style={{ backgroundImage: `url(${imgbg})` }}>
    <img className="bgr-gradient gradient1" src={shape1} alt="Whitelabel NFT" />
    <img className="bgr-gradient gradient2" src={shape2} alt="Whitelabel NFT" />
    <img className="bgr-gradient gradient3" src={shape3} alt="Whitelabel NFT" />
          ...
          <div className="slider-item">
            <div className="themesflat-container ">
              <div className="wrap-heading flat-slider flex">
                ...
                <div className="image">
                  <img className="img-bg" src={props.item.imgbg} alt="Whitelabel NFT" />
                  <img src={props.item.img} alt="Whitelabel NFT" />
                </div>
              </div>
            </div>
          </div>
